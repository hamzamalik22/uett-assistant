...
def calculator(request, department_id, semester_id):
    ...
    if request.method == 'POST':
        ...
        if grade_form.is_valid():
            ...
            context = {'department': department, 'semester': semester, 'subjects': [subject.name for subject in subjects], 'subject_gpas': list(subject_gpas.values()), 'total_gpa': total_gpa,'title' : 'Calculate GPA'}
